...
class ez_Animation
{
  ...
  ez_Animation(String atlas_path, float w_sprite, float h_sprite, float duration, boolean looping)
  {
  ...
  //
  ez_Animation(String atlas_path, float w_sprite, float h_sprite)
  {
    this(atlas_path, w_sprite, h_sprite, 0.02f, true);
  }
  ...
  void render(float x, float y)
  {
    ...
    destination.copy(atlas, int(item.x*sprite_width), 
      int(item.y*sprite_height), int(sprite_width), 
      int(sprite_height), 0, 0, int(sprite_width), int(sprite_height));
